...
/* harmony import */ var _components_preloader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/preloader */ "./src/js/components/preloader.js");
...
/* harmony import */ var _components_navbar_selector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/navbar-selector */ "./src/js/components/navbar-selector.js");
/* harmony import */ var _components_navbar_selector__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_navbar_selector__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_google_ads_mark__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/google-ads-mark */ "./src/js/components/google-ads-mark.js");
/* harmony import */ var _components_google_ads_mark__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_google_ads_mark__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _components_lightBox__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_lightBox__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_infinityScroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/infinityScroll */ "./src/js/components/infinityScroll.js");
/* harmony import */ var _components_infinityScroll__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_infinityScroll__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _components_burger__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_burger__WEBPACK_IMPORTED_MODULE_6__);
...
/***/ () => {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const textBoxes = document?.querySelectorAll(".blog-item__post");
    
    function textFormat() {
        textBoxes?.forEach((textBox, index) => {
          const textBoxHeight = textBox?.clientHeight;
      
          if (textBoxHeight >= 150) {
            textBox?.classList.add('hidden-post');
            readBtns[index]?.classList.remove('hidden');
            readBtns[index]?.addEventListener('click', () => {
              textBox?.classList.remove('hidden-post');
              readBtns[index]?.classList.add('hidden');
            ...
            hideBtns[index]?.addEventListener('click', () => {
              textBox?.classList.add('hidden-post');
              readBtns[index]?.classList.remove('hidden');
              hideBtns[index]?.classList.add('hidden');
            });
          }
        });
      }
