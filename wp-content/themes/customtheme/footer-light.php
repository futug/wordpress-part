<footer class="footer footer_light">
          <div class="footer__container container">
            <div class="footer__contacts-bar">
              ...
              ><a
                href="mailto:info@sernero.com"
                class="footer__contacts-bar-item"
                ><svg class="footer__contacts-bar-ico">
              ...
              >
              <div class="footer__contacts-bar-item">
                <svg class="footer__contacts-bar-ico">
            ...
            <div class="footer__address">
              ...
              <div class="footer__address-content">
                ...
                <p class="footer__address-text">
                  SERNERO ADVERTISING LTD 42 Lynwood Terrace Newcastle Upon Tyne
                  NE4 6UN
                </p>
              </div>
            </div>
            ...
            <div class="footer__contacts">
              ...
              <div class="footer__contacts-list">
                <a href="tel:+3726188161" class="footer__contacts-item"
                  ...
                  <p class="footer__contacts-text">+372 618 81 61</p></a
                ><a href="mailto:info@sernero.com" class="footer__contacts-item"
                  ><svg class="footer__contacts-ico">
                    <use xlink:href="<?php bloginfo('template_url'); ?>/assets/img/sprite.svg#mail"></use>
                  </svg>
                  <p class="footer__contacts-text">info@sernero.com</p></a
                >
            ...
            <a href="/privacy-policy.html" class="footer__privacy"
              >Политика конфиденциальности и условия использования</a
            >
            <div class="footer__socials-bar socials-bar">
              ...
              ><a
                ...
                target="_blank"
                ><svg class="socials-bar__ico">
                  <use xlink:href="<?php bloginfo('template_url'); ?>/assets/img/sprite.svg#whatsapp-ico"></use></svg></a>
            </div>
